...
import NetworkLogItem from 'ui/shared/logs/NetworkLogItem';
...
const TxNetworkLogs = () => {
  ...
  return (
    <Box>
      ...
      { data?.items.map((item, index) => <NetworkLogItem key={ index } { ...item } type="transaction" isLoading={ isPlaceholderData }/>) }
    </Box>
  );
};

export default TxNetworkLogs;
